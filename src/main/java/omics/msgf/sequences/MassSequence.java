...
public interface MassSequence extends Sequence
{
    ...
    /**
     * This is a special method to handle protein fasta sequences in which allows the query of a mass of an amino at a
     * certain index.
     *
     * @param index the index of the item in which mass we want to know
     * @return the integer mass of the amino acid at the given position, 0 if the position corresponds to a TERMINATOR
     ...
     * @return the integer mass of the given segment. If there are unknown amino acids in the segment, their masses will
     * be treated as 0.
     */

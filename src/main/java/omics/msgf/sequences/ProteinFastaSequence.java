...
/**
 * This class is a wrapper to the FastaSequence that uses Amino Acids as the alphabet by default. to amino acid masses.
 *
 * @author jung
 */
public class ProteinFastaSequence extends FastaSequence implements MassSequence
{
    ...
    private AminoAcidSet alpha = DBConstants.AA;
    ...
    {
        super(filepath, DBConstants.AMINO_ACIDS_20, DBConstants.PROTEIN_FILE_EXTENSION);
        initialize();
    }
...
/***** Constructors *****/
    /**
     * Constructor using a customized alphabet. See FastaSequence, for the syntax of the alphabet argument.
     *
     * @param filepath the path to the fasta file
    ...
    {
        super(filepath, alphabet, DBConstants.PROTEIN_FILE_EXTENSION);
        initialize();
    }

...
public class FastaSequence implements Sequence
{
    ...
    {
        this(filepath, alphabet, DBConstants.FILE_EXTENSION);
    }
     ...
     *
     * @param filepath     the path to the fasta file.
     * @param alphabet     the specifications alphabet string. This could take the predefined AminoAcid strings defined
     *                     in this class or customized strings.
    ...
    public FastaSequence(String filepath, String alphabet, String seqExtension)
    {
        ...
        String metaFile = basepath + this.seqExtension + DBConstants.ANNO_FILE_SUFFIX;
        ...
        try {
            ...
            while ((s = in.readLine()) != null) {
                ...
                // annotation line
                    ...
                    sequence.put(DBConstants.TERMINATOR);
                    original.append('_');
        ...
        try {
            ...
            while ((s = in.readLine()) != null) {
                ...
                // annotation line
                    ...
                    sequence.put(DBConstants.TERMINATOR);
                    original.append(DBConstants.TERMINATOR_CHAR);
...
//			this.original = fc.map(FileChannel.MapMode.READ_ONLY, 2*Integer.SIZE/Byte.SIZE + size, size);
    ...
    public byte getByteAt(long position)
    {
        ...
        if (position >= this.size) return DBConstants.TERMINATOR;
  ...
  public String toString(long start, int ext) {
    ...
    /**
     * This method make the buffers writeable. This must be called before the set method is usable
     */

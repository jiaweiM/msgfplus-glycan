...
public class DBConstants
{
     ...
     * The syntax for alphabet encoding is very simple. All amino acids that are grouped together by the token separator
     * ":" are considered equivalent when doing the mapping. When doing the reverse mapping the first letter in the

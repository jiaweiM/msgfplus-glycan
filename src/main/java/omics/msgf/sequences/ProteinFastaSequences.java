...
public class ProteinFastaSequences implements MassSequence
{
    ...
    {
        this(directory, DBConstants.AMINO_ACIDS_18, AminoAcidSet.getStandardAminoAcidSetWithFixedCarbamidomethylatedCysWithTerm(), randomAccess);
    }
    ...
    /**
     * Helps translate the give position to a pair composed of a index of the fasta sequence and the subindex in that
     * sequence.
     *
     * @param position the absolute position
     * @return the relative position with the upper 32 bits as the sequence index and the lower 32 bits as the index in
     * the sequence.
     */

...
public abstract class ByteSequence implements Comparable<ByteSequence>
{
    ...
    /**
     * Lexographic compare that break once it finds the tie breaker index before hashSize.
     *
     ...
     * @return a positive number if this > other, a negative if other > this and 0 if they are equal. The longest common
     * prefix length can be retrieved by taking absolute value of the return value minus 1.
     */
     ...
     * @return the number that is returned is the number of positions in which the prefixes of the two objects are
     * equal. 0 means that nothing is common.
     */

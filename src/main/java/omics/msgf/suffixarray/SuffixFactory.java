...
/**
 * SuffixFactory and Suffix classes. This class will allow the creation of light weight suffix objects given a long
 * sequence in the form of an Adapter object.
 *
 * @author jung
 */
public class SuffixFactory
{
     ...
     * @return the number of positions in which these 2 suffixes are in common or offset (if this number is greater).
     */

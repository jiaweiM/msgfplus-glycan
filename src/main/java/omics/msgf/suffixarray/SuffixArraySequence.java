...
import omics.msgf.sequences.FastaSequence;


/**
 * This abstract class allows different formats to be searchable using a SuffixArray as the database. This
 * implementation only allows the alphabet to be of sizeof(byte).
 *
 * @author jung
 */
public class SuffixArraySequence extends FastaSequence
{
    ...
    /**
     * Constructor using the specified alphabet set. If there is a letter not in the alphabet.
     *
     * @param filepath the path to the fasta file.
    ...
    {
        super(filepath, alphabet, DBConstants.FILE_EXTENSION);
    }
    ...
    /**
     * This method checks whether another sequence is contained by this sequence starting at a given positon.
     *
    ...
    /**
     * This method returns the size of longest common prefix between pattern and a suffix of this sequence at a given
     * positon.
     *
     * @param pattern the pattern to check.
     * @param start   the start position.

...
/**
 * The MassArray class is for fast localization of a mass given a database of amino acids.
 *
 * @author jung
 */
public class MassArray
{
    ...
    /**
     * Constructor that creates a MassArray from the amino acid sequence in fasta format and the name of the output
     * file. This class uses a FastaSequence object because the amino acid nomenclature and mass is needed to calculate
     * the mass.
     *
    ...
    /**
     * Constructor that takes the FastaSequence object as the only input. It uses the default file name to check or
     * create the pre-processed MassArray object.
     *
     * @param sequence the FastaSequence object.
     */
    ...
    /**
     * This is the general matching routine that returns all matching elements in the MassArray. It can also return a
     * null MatchSet if nothing is found.
     *
    ...
    /**
     * Helper method that creates the massArrayFile.This routine requires a FastaSequence object because we need to
     * deduct the mass of the amino acids according to the amino acid letters. The current format writes all masses, all
     * starts and all ends.Of course also write the size and id as first and second integers.
     *

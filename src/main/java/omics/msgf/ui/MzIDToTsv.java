...
import omics.msgf.msutil.FileFormat;
import omics.msgf.mzid.MzIDParser;
import omics.msgf.mzml.MzMLAdapter;
import omics.msgf.params.EnumParameter;
...
public class MzIDToTsv
{
    ...
    public static void main(String argv[])
    {
        ...
        ParamManager paramManager = new ParamManager("MzIDToTsv", VERSION, MSGFPlus.RELEASE_DATE, "java -Xmx3500M -cp MSGFPlus.jar omics.msgf.ui.MzIDToTsv");

...
import omics.msgf.params.IntRangeParameter;
...
public class MSGFDB
{
    ...
    private static String runMSGFDB(File specFile, SpecFileFormat specFormat, File outputFile,
            ParamManager paramManager)
    {
        ...
        ArrayList<SpecKey> specKeyList = SpecKey.getSpecKeyList(specAcc.getSpecItr(), startSpecIndex, endSpecIndex, minCharge, maxCharge, activationMethod, DBConstants.MIN_NUM_PEAKS_PER_SPECTRUM);
        ...
        if (showFDR && !useTDA && numMatchesPerSpec == 1) {
            ...
            try {
                ...
                int dbCol = 8;
                int scoreCol = 11;
                omics.msgf.fdr.ComputeFDR.computeFDR(tempFile, null, scoreCol, false, "\t",

package omics.msgf.msgf.analysis;

import omics.msgf.msutil.Pair;
import omics.msgf.msutil.ScoredString;
...
public class ROCGenerator
{
    ...
    public static void printROCCurve(String identifier, File targetFile, File decoyFile, int scoreCol,
            boolean isGreaterBetter, String delimeter,
            int scanNumCol, int pepCol, ArrayList<Pair<Integer, String>> reqStrList, boolean isConcatenated,
    ...
    private static ArrayList<ScoredString> getScoredStringList(File file, int scoreCol, boolean isGreaterBetter,
            String delimeter, int scanNumCol,
            int pepCol, ArrayList<Pair<Integer, String>> reqStrList, boolean hasHeader, int dbCol, String decoyPrefix,
            boolean isTarget)
    {
...
//				}
    ...
    public static TreeMap<Float, Float> printROCCurve(String identifier, ArrayList<Float> target,
            ArrayList<Float> decoy,

...
//	private Integer numMS1Features = null;
    ...
    /**
     * Take a spectrum file name, infers the spectrum format by recognizing the extension and returns the spectrum file
     * format.
     *
    ...
    /**
     * Correct charge of the precursor and set the charge of the peaks of this spectrum to max(1, charge - 1).
     *
     * @param charge charge
     */
    ...
    /**
     * Gets the spectrum index of this spectrum. Spectrum index is a 1-based sequential number of this spectrum in the
     * file.
     *
...
//			}
    ...
    /**
     * Returns a list of peaks that match the target mass within the tolerance value. The absolute distance between the
     * target mass and a returned peak is less or equal that the tolerance value. The current implementation cycles
     * through all peaks per call.
     *
     * @param mass      target mass.
     * @param tolerance tolerance.
     * @return an ArrayList object of the matching peaks. The array will be empty if there are no peaks within
     * tolerance.
     */
    ...
    /**
     * Returns the most intense peak that is within tolerance of the target mass. The current implementation takes
     * linear time.
     *
     * @param mass      target mass.
     * @param tolerance tolerance.
    ...
    /**
     * Returns a list of peaks that match the target mass within the specified range. Assuming spectrum is sorted by
     * mass!!!
     *
    ...
    /**
     * Goes through the peaks and set their rank by intensity. Rank 1: higest intensity peak
     */
  ...
  public void outputPkl(PrintStream out)
  {
    ...
    /**
     * Output this spectrum to the input PrintStream as the mgf format. It needs to be changed later.
     *
    ...
    /**
     * Output this spectrum to the input PrintStream as the dta format. It needs to be changed later.
     *

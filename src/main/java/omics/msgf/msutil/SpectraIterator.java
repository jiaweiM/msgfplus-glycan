...
import omics.msgf.parser.LineReader;
...
public class SpectraIterator implements Iterator<Spectrum>, Iterable<Spectrum>
{
    ...
    /**
     * Added by Louis Enables iterator to read multiple files seamlessly.
     *
    ...
    /**
     * @return Filename of source file of next spectrum to be returned by next(). Returns null if last spectrum in last
     * file was returned.
     */

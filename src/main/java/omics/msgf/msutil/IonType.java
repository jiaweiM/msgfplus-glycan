...
//        ionTable.put("i_z2", new InternalIon("i_z2", 2, (float)((Z.offset+Composition.ChargeCarrierMass())/2)));
    ...
    /**
     * Return ion type from string. Ion name format: a/b/c  a=[sp], (s: suffixIon, p: prefixIon, i: internalIon, r:
     * precursorIon),  b=charge,  c=offset or Ion name format: [abcxyz][+-]c,  (c=['H''H2''H2O''NH3'NH'] or c=offset)
     * Examples: y2-12.02   a+1.002-H2O  i/2/+1.23  s/1/-22.11  b-H2O-NH3 Returns null if format is not valid or ion
     * does not exist
     *
     * @param name
     * @return
    ...
    public static ArrayList<IonType> getAllKnownIonTypes(int maxCharge, boolean removeRedundancy, boolean addPhosphoNL,
            boolean addiTRAQNL, boolean addTMTNL)
    {
        String nlString;

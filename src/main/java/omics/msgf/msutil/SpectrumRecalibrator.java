...
import omics.msgf.msgf.LinearCalibration;
import omics.msgf.msgf.Tolerance;

/**
 * This class creates an object that re-calibrates Spectrum objects. Currently, it tries to find alpha and beta that
 * converts a mass m into alpha*m + beta. It uses the least squares method.
 *
 * @author sangtaekim
 */

...
import omics.msgf.msgf.MassFactory;
...
public class CompositionFactory extends MassFactory<Composition>
{
    ...
    public ArrayList<Composition> getIntermediateCompositions(Composition source,
            Collection<Composition> destCompositionList)
    {

...
/**
 * This filtering method guarantees that for any window of the determined size placed around a given peak, the peak is
 * ranked better than a determined parameter.
 *
 * @author jung
 */
public class WindowFilter implements Reshape
{
     ...
     * @param window the window size in Daltons. The window will be taken to the left and right of the amount in Daltons

...
public class Peak implements Comparable<Peak>
{
    ...
    /**
     * Calculates the absolute mass difference between 2 peaks. The m/z values are used for this method.
     *
    ...
    /**
     * Given the parent mass return the mass of the uncharged complement peak. This assumes that the parent mass has no
     * charge (H).
     *
  ...
  */
    ...
    /**
     * Compares this peak to another peak by mass. If the masses are equal, compare by intensity.
     */
    ...
    /**
     * String representation of this peak. This is simply the mass followed by its intensity.
     *
    ...
    /**
     * Creates a new peak with the same parameters as the current peak, but with a mass offset given.
     *
     * @param offset the offset to add
     * @return a peak object such that the getMass methods this return this.getMass()+offset as mass.
     */
    ...
    /**
     * Comparator to sort peaks by intensity. If the intensities are equal, sort by mass
     *
     * @author Sangtae Kim
     */
    public static class IntensityComparator implements Comparator<Peak>
    {
         ...
         * @param p1 first peak to compare.
         * @param p2 second peak to compare.
         * @return true, if both peaks have the same mass and intensity; false otherwise.
         */

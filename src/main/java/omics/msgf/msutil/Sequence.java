...
/**
 * Superclass for a list of masses. Peptide, GappedPeptide, Tag should extend this class.
 *
 * @author jung
 */
public class Sequence<T extends Matter> extends ArrayList<T>
{
    ...
    /**
     * Sums up the masses of the specified range of masses (half open intervals).
     *

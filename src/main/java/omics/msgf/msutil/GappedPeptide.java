...
/**
 * This class construct a peptide representation based on a string of amino acids. The strings allows for brackets that
 * groups amino acids together effectively allowing for gaps. This data structure is backed by an array of compositions
...
public class GappedPeptide extends Sequence<Composition>
{
    ...
    /**
     * Construct a peptide based on the string. Brackets are allowed for grouping of amino acids. For example,
     * [AC]F[DR]G.
     *
     * @param sequence
     */

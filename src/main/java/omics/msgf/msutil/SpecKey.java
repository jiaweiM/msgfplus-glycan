...
public class SpecKey extends Pair<Integer, Integer>
{
    ...
    /**
     * Return the SpecKey list of given spectrum iterator
     *
     * @param itr                    iterator
     * @param startSpecIndex         start index
     * @param endSpecIndex           end index
     * @param minCharge              min charge for unknown charge
     * @param maxCharge              max charge for unknown charge
     * @param activationMethod       {@link ActivationMethod} required
     * @param minNumPeaksPerSpectrum min number of peaks per spectrumn required.
     * @return list of spectrum keys.
     */
...
//				System.out.println("Spectrum " + spec.getScanNum() + " has too few peaks (#Peaks: " + spec.size()+"): ignored.");
    ...
    public static ArrayList<SpecKey> getFusedSpecKeyList(Iterator<Spectrum> itr, int startSpecIndex, int endSpecIndex,

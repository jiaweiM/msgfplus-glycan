...
import omics.msgf.misc.ExceptionCapturer;
import omics.msgf.misc.ProgressData;
import omics.msgf.misc.ProgressReporter;
import omics.msgf.misc.ThreadPoolExecutorWithExceptions;
import omics.msgf.mzid.MzIDParser;
...
public class AnnotatedSpectra implements ProgressReporter, ExceptionCapturer
{
    ...
    public AnnotatedSpectra(File[] resultFiles, File specDir, AminoAcidSet aaSet, float fdrThreshold,
            boolean dropErrors)
    {
        this.resultFiles = resultFiles;
        this.specDir = specDir;
    ...
    public static class ConcurrentAnnotatedSpectraParser extends AnnotatedSpectra implements Runnable
    {
        ...
        public ConcurrentAnnotatedSpectraParser(File[] resultFiles, File specDir, AminoAcidSet aaSet,
                float fdrThreshold, boolean dropErrors, List<Spectrum> resultList, List<String> errorList)
        {

...
public class Composition extends Matter
{
    ...
    public static Double getMass(String compositionStr)
    {
        ...
        double modMass = compTable.get("C") * Composition.C
    ...
    /**
     * Comparator method for 2 edges in composition representation. The order is defined by the mass of the edges and
     * then by the composition itself.
     *
     * @param comp1 the composition of the first edge.
     * @param comp2 the composition of the second edge.
     * @return positive if the second edge is greater than the first one, negative if the reverse is true and 0 if they
     * are equal.
     */

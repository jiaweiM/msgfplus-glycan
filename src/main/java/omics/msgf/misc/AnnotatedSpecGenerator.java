...
import omics.msgf.msutil.SpectraMap;
...
import omics.msgf.parser.MzXMLSpectraMap;
...
//				"\t[-fixMod 0/1/2] (0: NoCysteineProtection, 1: CarbamidomethyC (default), 2: CarboxymethylC)\n"
    ...
    public static void generateAnnotatedSpectra(File resultFile, File specDir, File outputFile, int specIndexCol,
            int specFileCol, int pepCol, int chargeCol,
            int scoreCol, boolean isGreaterBetter, float threshold, boolean uniquePeptide,

...
//		ptmMap.put('q', "Deamidation");
    ...
    public static void convertIntoIPRGReport(String msgfOutput, HashMap<Character, String> ptmMap, String iPRGOutput,
            boolean nTerm) throws Exception
    {
    ...
    public static void mergeSearchResults(String targetResults, String decoyResults,
            String mergedResults) throws Exception
    {

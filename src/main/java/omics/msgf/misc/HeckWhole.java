...
//		printSet1Exclusive(msgfResults, mascotResults, rawFileName, mascotScores, msgfScores);
    ...
    private static void printSet1Exclusive(Hashtable<String, String> set1, Hashtable<String, String> set2,
            String rawFileName,
...
//			String pepSeq = pep.substring(pep.indexOf('.')+1, pep.lastIndexOf('.'));
    ...
    public static void extractGoodSpectraFromSum(String enzyme, String cidOutFileName,
            String etdOutFileName) throws Exception
    {
        File dir = new File(System.getProperty("user.home") + "/Research/Data/HeckWhole");

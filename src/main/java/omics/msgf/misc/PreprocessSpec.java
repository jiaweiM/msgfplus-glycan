...
public class PreprocessSpec
{
    ...
    public static void convert(File source, File target, ActivationMethod activationMethod, InstrumentType instType,
            Enzyme enzyme, boolean writeActivationMethod) throws Exception
    {
    ...
    public static void convertFile(File sourceFile, SpecFileFormat sourceFileFormat, File target,
            ActivationMethod activationMethod, InstrumentType instType, Enzyme enzyme, PrintStream out,
            boolean writeActivationMethod) throws Exception
    {

package omics.msgf.msdictionary;

import omics.msgf.parser.FullyBufferedLineReader;
...
//		out = System.out;
    ...
    private void writeSixFrameTranslationConsideringTermCodon(String chromosome, int segmentPos, String segment,
            PrintStream out)
    {
        if (segment.length() < MIN_PROTEIN_SIZE * 3)
            return;

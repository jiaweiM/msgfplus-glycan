...
public class ConcurrentMSGFDB
{
    ...
    public static class RunDBSearch implements Runnable
    {
        ...
        public RunDBSearch(final DBScanner scanner, final int numberOfAllowableNonEnzymaticTermini,
                final int searchMode, final int fromIndex, final int toIndex)
        {
    ...
    public static class RunMSGFDB implements Runnable
    {
        ...
        )
        {
            ...
            this.scanner = new DBScanner(specScanner, sa, enzyme, aaSet, numPeptidesPerSpec, minPeptideLength, maxPeptideLength, DBConstants.NUM_VARIANTS_PER_PEPTIDE, 0, false);
            this.numberOfAllowableNonEnzymaticTermini = numberOfAllowableNonEnzymaticTermini;
            this.storeScoreDist = storeScoreDist;

...
import static omics.msgf.msutil.Composition.*;
...
//	private boolean showDecoy;
    ...
    /**
     * @return number of threads used for search
     */
    ...
    /**
     * @return mass of charge carrier particle.
     */
    ...
    public String parse(ParamManager paramManager)
    {
        ...
        if (!specPath.isDirectory()) {
            ...
            // generate the output file name if it is not set
            if (outputFile == null) {
        ...
        } else    // spectrum directory
        {
            ...
            // batch search of multiple files

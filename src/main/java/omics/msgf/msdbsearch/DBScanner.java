...
import omics.msgf.msgf.*;
import omics.msgf.msscorer.NewRankScorer;
import omics.msgf.msscorer.SimpleDBSearchScorer;
import omics.msgf.msutil.*;
import omics.msgf.msutil.Modification.Location;
...
//					System.out.println("Debug");
                    ...
                    if (lcp >= peptideLength + 2)    // peptide, N-term, C-term are shared
                    {
                        ...
                        if (prevMatchList[peptideLength] != null) {
                            for (DatabaseMatch m : prevMatchList[peptideLength]) {
                                ...
                                if (post == DBConstants.TERMINATOR_CHAR) {
                                    m.addIndex(index);
                                }
                            }
                        }
                ...
                } else if (lcp == 0)    // preceding aa is changed
                {
                    ...
                    isProteinNTerm = precedingAA == DBConstants.TERMINATOR_CHAR;
                    ...
                    if (peptideLengthIndex == 1)    // N-term residue
                    {
                        ...
                        if (!containsCTermMod) {
                            ...
                            if (peptideLengthIndex < minPeptideLength) {
                                ...
                                boolean success;
                                if (isProteinCTerm = (sequence.getCharAt(index + peptideLengthIndex + 1) == DBConstants.TERMINATOR_CHAR))    // protein C-term
...
//					}
                    ...
                    if (enzyme != null) {
                        ...
                        isProteinCTerm = (cTermNeighboringResidue == DBConstants.TERMINATOR_CHAR);
                        if (enzyme.isCTerm()) {
...
//					String key = pre+pepSeq+post;
    ...
    // for MS-GFDB
    public synchronized void addDBSearchResults(List<MSGFDBResultGenerator.DBMatch> gen, String specFileName,

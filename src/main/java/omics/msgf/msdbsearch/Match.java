...
import omics.msgf.msgf.ScoreDist;
...
public class Match implements Comparable<Match>
{
     ...
     * @param peptideMass        peptide mass
     * @param nominalPeptideMass nominal peptide mass
     * @param charge             precursor charge
     * @param pepSeq             peptide sequence
     * @param actMethodArr       {@link ActivationMethod}
     */
    ...
    public void addAdditionalFeature(String key, String value)
    {
        if (additionalFeatureList == null)
            additionalFeatureList = new ArrayList<>();
        additionalFeatureList.add(new Pair<>(key, value));
    }
    ...
    public static class SpecProbComparator implements Comparator<Match>
    {
        ...
        {
            return Double.compare(arg1.getSpecEValue(), arg0.getSpecEValue());
        }
    }
}

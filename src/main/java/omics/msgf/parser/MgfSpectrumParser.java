...
//	    	System.out.println(spec.getScanNum() + " " + spec.getPrecursorPeak());
    ...
    /**
     * Implementation of readSpectrum method. Implicitly lineReader points to the start of a spectrum. Reads mgf file
     * line by line until the spectrum ends, generate a Spectrum object and returns it. If it cannot read a spectrum, it
     * returns null.
     *
...
//  				}
    ...
    /**
     * Implementation of getSpecIndexMap object. Reads the entire spectrum file and generates a map from a spectrum
     * index to the file position of the spectrum.
     *
    ...
    {
        Hashtable<Integer, SpectrumMetaInfo> specIndexMap = new Hashtable<>();
        String buf;
        long offset = 0;
        int specIndex = 0;

...
import omics.msgf.msgf.DeNovoGraph.Edge;
...
//			return scoredSpec2.getScore(pep, graph);
    ...
    public ArrayList<String> getReconstructions(float specProbThreshold, float numRecsThreshold, boolean isNumInclusive,
            SuffixArray sa)
    {
        return null;
    }

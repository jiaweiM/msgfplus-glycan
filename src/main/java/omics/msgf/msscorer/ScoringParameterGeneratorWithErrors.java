...
public class ScoringParameterGeneratorWithErrors extends NewRankScorer
{
    ...
    public ScoringParameterGeneratorWithErrors(SpectraContainer specContainer, NewScorerFactory.SpecDataType dataType,
            boolean considerPhosLoss, boolean consideriTRAQLoss, boolean considerTMTLoss, boolean applyDeconvolution)
    {
    ...
    public static void generateParameters(
            File specFile,
            NewScorerFactory.SpecDataType dataType,
            AminoAcidSet aaSet,
            File outputDir,
            boolean isText,
            boolean verbose,
